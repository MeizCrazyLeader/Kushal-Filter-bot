...
<b>Mʏ Nᴀᴍᴇ Is <a href="https://t.me/{}">{}</a>, I Cᴀɴ Pʀᴏᴠɪᴅᴇ ғɪʟᴇs ☺ Jᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ As Aᴅᴍɪɴ EɴJᴏʏ 😍</b>"""

    HELP_TXT = """<b>Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
 
    ABOUT_TXT = """
<b>‣ ᴍʏ ɴᴀᴍᴇ : <a href="https://t.me/{}">ʙᴏᴛ</a>
‣ ᴄʀᴇᴀᴛᴏʀ : <a href="https://t.me/MasterContact_bot">⏤͟͞𝙇𝙀𝘼𝘿𝙀𝙍 </3></a>
...
ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/MasterContact_bot">⏤͟͞𝙇𝙀𝘼𝘿𝙀𝙍 </3></a></b>"""
    ...
    SOURCE_TXT = """
<b>This Repository is PVT. If you want to make your own bot through my repository. Contact @MasterContact_bot
"""
...
ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ :
<code>[Button Text](buttonurl:https://t.me/Students_Helpers)</code>
...
◈ <b>Sᴇᴀʀᴄʜ ғɪʟᴇs Wɪᴛʜ Cᴏʀʀᴇᴄᴛ Sᴘᴇʟʟɪɴɢ:</b>

<b>➙ ᴅᴏɴ'ᴛ ᴅᴏ ᴀɴʏ ꜱᴇʟꜰ ᴘʀᴏᴍᴏᴛɪᴏɴ. 
➙ ᴅᴏɴ'ᴛ ꜱᴇɴᴅ ᴀɴʏ ᴋɪɴᴅ ᴏꜰ ᴘʜᴏᴛᴏ, ᴠɪᴅᴇᴏ, ᴅᴏᴄᴜᴍᴇɴᴛꜱ, ᴜʀʟ, ᴇᴛᴄ...
➙ ᴅᴏɴ'ᴛ ʀᴇǫᴜᴇꜱᴛ ᴀɴʏ ᴛʜɪɴɢꜱ ᴏᴛʜᴇʀ ᴛʜᴀɴ ғɪʟᴇs ᴍᴀɴʏ ᴍᴏʀᴇ.</b>
...
𝟷. ᴅᴜᴇ ᴛᴏ ʜɪɢʜ ᴄᴏᴘʏʀɪɢʜᴛ ɪssᴜᴇs @TG_Bots_Supporter</b>"""
...
<b>🔰 Cʀᴇᴀᴛᴏʀ : <a href="https://t.me/MasterContact_bot">⏤͟͞𝙇𝙀𝘼𝘿𝙀𝙍 </3></a>
🔰 Cʜᴀɴɴᴇʟ : <a href="https://t.me/Students_Helpers">𝐌𝐎𝐕𝐈𝐄𝐒 𝐂𝐇𝐀𝐍𝐍𝐄𝐋</a>
🔰 Gʀᴏᴜᴘ : <a href="https://t.me/Tutorial_To_Open_My_Links">𝐌𝐎𝐕𝐈𝐄 𝐑𝐄𝐐𝐔𝐄𝐒𝐓 𝐆𝐑𝐎𝐔𝐏</a></b>"""
...
➻ sᴏᴏɴ ʟᴀᴜɴᴄʜɪɴɢ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴ ᴛᴏ ᴇᴀsɪʟʏ ᴀᴄᴄᴇss ᴛʜᴇ ʜɪɢʜ ǫᴜᴀʟɪᴛʏ ғɪʟᴇs.</b>"""
